...
public class ATM {
    ...
    static class AccountModel {
        ...
        //Constructor
        public AccountModel(int acc1, String pass, double amount, String name) {
            this.accountNo = acc1;
            this.password = pass;
            this.amount = amount;
        ...
        public void setAccountNo(int acc1) {
            this.accountNo = acc1;
        }
        ...
        public boolean checkLogin(int acc1, String pass) {
            ...
            return acc1 == accountNo && pass.equals(password);
        }
    ...
    static class View {
        ...
        public static void khoiTaoMenu() {

            Scanner sc = new Scanner(System.in);

            // Tạo một tài khoản mới và gán giá trị cho nó
            AccountModel acc1 = new AccountModel(1, "abc123", 2000000, "Doan Cao Nhat Ha");
            ...
            while (choice.equalsIgnoreCase("y")) {
                ...
                switch (action) {
                    ...
                    case 4 -> {
                        ...
                        AccountModel acc2 = new AccountModel(2, "12345", 50000, "Hoang Thanh Ha");
...
//        public static AccountModel newAccount(int acc1, String pass, double amount, String custName) {
//            AccountModel acc = new AccountModel();
//            acc.setAccountNo(acc1);
